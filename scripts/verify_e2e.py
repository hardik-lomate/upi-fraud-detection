...
r = requests.post(f"{BASE}/predict", json={
    "sender_upi": "alice@upi", "receiver_upi": "bob@upi",
...
r2 = requests.post(f"{BASE}/predict", json={
    "sender_upi": "fraud@upi", "receiver_upi": "fraud@upi",
...
r3 = requests.post(f"{BASE}/predict", json={
    "sender_upi": "newuser999@upi", "receiver_upi": "shop@upi",
...
r8 = requests.post(f"{BASE}/feedback", json={
    "transaction_id": "test_verify_001",
